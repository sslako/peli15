...
void change_phone_number(const string number, const std::string file_name,
                         std::map< std::string, Student* >& numerical_order,
    ...
    relevant_student = numerical_order.at(number);
    relevant_student->phone_number = new_number;
    ...
    while(true) {
        ...
        if(command == "U" or command == "u") {
            ...
            // TODO: Add functionality here
                ...
                change_phone_number(parts.at(1), file_name, student_numbers, user_ids);
            }
